...
<div class="col-lg-7" style="padding-bottom: 120px">
	@include('admin.blocks.error')
		...
		<form action="" method="POST">
			...
			<div class="form-group">
				<label>Price Old</label> <input class="form-control" name="txtPriceOld" value="{!! old('txtPriceOld',isset($product) ? $product['price_old'] : null) !!}"
					placeholder="Please Enter Price Old" />
			</div>
			<div class="form-group">
				<label>Promote Percent</label> <input class="form-control" name="txtPromotePercent" value="{!! old('txtPromotePercent',isset($product) ? $product['promote_percent'] : null) !!}"
